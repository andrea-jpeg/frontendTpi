...
var Menu = _react.default.forwardRef(function Menu(props, ref) {
  var autoFocusProp = props.autoFocus,
      ...
      other = (0, _objectWithoutProperties2.default)(props, ["autoFocus", "children", "classes", "disableAutoFocusItem", "MenuListProps", "onClose", "onEntering", "open", "PaperProps", "PopoverClasses", "theme", "variant"]);
  var autoFocus = autoFocusProp !== undefined ? autoFocusProp : !disableAutoFocusItem;

  var menuListActionsRef = _react.default.useRef();

  var firstValidItemRef = _react.default.useRef();

  var firstSelectedItemRef = _react.default.useRef();
